...
- **[`yandex/`](yandex/README.md)** — `ya` (make/test/tool), `arc` (status/log/diff/show) — envelope + adapters; design: [`ya-roadmap.md`](../../ya-roadmap.md), ROI: [`ya-analitycs.md`](../../ya-analitycs.md)
